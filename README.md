...
- [x] 📖 小说转漫画（2026-09-12）：第五种入口——上传正文→拆成漫画页分镜（场景+人物+对白，可指定目标页数）→逐页 t2i 单格漫画（尺寸 10 档（含 512/768 小尺寸快出图）/质量三档/对白呈现：气泡（透明度·字色·字号可调）·字幕条·不呈现）→详情「漫画页」浏览+📄 导出 PDF/📜 导出长图；🚀 一键出片全程自动（终态「漫画就绪」，页面即交付物，无视频链）
