...
_KIND_SYSTEMS = {
    ...
    "appearance": (
        ...
        "模糊形容词必须强化为对图像模型有效的同向具体约束（2026-09-13 真机判例："
        "「体型：前凸后翘，身材高挑，大胸」生成仍偏胖，补全为「身材高挑纤细，"
        "四肢修长，体脂低」才跟随）——体型行尤其如此：高挑→加纤细/四肢修长/体脂低；"
        "丰满→写具体曲线部位；健壮→肌肉线条分明/肩宽腰窄；瘦弱→单薄/清瘦。"
        "只沿原方向强化，不得改变体型意图；肤色/发型等其他行的模糊词同理换具体特征。"),
    "appearance:prop": (
